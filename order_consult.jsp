...
<head>
    ...
    <title>마더앤베이비 관리자 - <%=getTitle()%>검색</title>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel tile fixed_height_460">
                                ...
                                <div class="x_content">
                                            ...
                                            <ul class="list-unstyled">
                                                ...
                                                <li>
                                                    ...
                                                    <label for="loc_all">전체
                                                        <span class="badge bg-default">22</span></label>
                                                </li>
                                                <li>
                                    ...
                                    <hr>
                                        <button id="send" type="submit" class="btn btn-primary btn-sm" onclick="search()">위 조건으로 검색</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="x_panel tile fixed_height_460">
                                ...
                                <div class="x_content">
                                    <div class="table-responsive">
                                        ...
                                        <div style="display:none;" id="finalView" class="animate-bottom">
