...
<%
    ...
    else if (item._workType.equals("INHOUSE"))
    {
        workType = "입주 선호";
    }
    else if (item._workType.equals("BOTH"))
    {
        workType = "입주/출퇴근 둘 다 선호";
    }
    else
    {
        workType = "지정되지 않음";
...
<head>
    ...
    <script>
        ...
        function setEditFields() {
            ...
            document.getElementById('subBelong_up').innerHTML = getRegionName_Up(<%= item._belong %>);
            document.getElementById('subWish_up').innerHTML = getRegionName_Up(<%= item._wish %>);
        ...
        function getRegionName_Up(index) {
            var name = '';
            var up = -1;
            for (var i = 0; i < regions.length; i++) {
                if (regions[i]._index == index) {
        ...
        function deleteMe() {
            $.post("_helper_update.jsp?DELETE&INDEX=" + helperIndex, '')
                ...
                <div class="">
                    <div class="page-title">
                        ...
                        <div class="title_right">
                            <a href="policy_helper.jsp" class="btn btn-primary btn-sm pull-right go-list">목록</a>
                            <a href="policy_helper_edit.jsp?HELPER=<%=_index%>" class="btn btn-default btn-sm pull-right jisa-modify">수정</a>
                            <a onclick="deleteMe()" class="btn btn-danger btn-sm pull-right jisa-delete" data-toggle="modal" data-target=".jisa-delete-modal">삭제</a>
                        </div>
                    </div>
                                ...
                                <div class="x_panel tile">
                                    ...
                                    <div class="x_content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="text" required="required" class="form-control" name="NAME" value="<%= item._name %>" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="text" required="required" class="form-control" name="SOCIAL_NUM" value="<%= item._socialNum %>" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="POST" placeholder="우편번호" value="<%= item._post %>" readonly>
                                                        <span class="input-group-btn">
                                                            <button type="button" class="btn btn-primary btn-addr-search">검색</button>
                                                        </span>
                                                    </div>
                                                    <input type="text" class="form-control addr1" name="ADDRESS1" placeholder="주소" value="<%= item._address1 %>" readonly>
                                                    <input type="text" class="form-control addr2" name="ADDRESS2" placeholder="상세주소" value="<%= item._address2 %>" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="text" class="form-control" name="MOBILE" placeholder="예시) 010-0000-0000" value="<%= item._mobile %>" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="text" class="form-control" name="PHONE" placeholder="예시) 02-0000-0000" value="<%= item._phone %>" readonly>
                                                </div>
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="x_panel tile">
                                    ...
                                    <div class="x_content">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="text" class="form-control " name="EDUCATION" value="<%= item._education %>" readonly />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="text" class="form-control " name="INSURANCE" value="<%= item._insurance %>" readonly />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="date" class="form-control " name="HEALTH_CARE" value="<%= df.format(item._health) %>" readonly />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    시작
                                                    <input type="date" class="form-control input-inline start-date" name="BENEFIT_BEGIN" value="<%= df.format(item._benefitBegin) %>" readonly />
                                                    <br/> 종료
                                                    <input type="date" class="form-control input-inline end-date" name="BENEFIT_END" value="<%= df.format(item._benefitEnd) %>" readonly />
                                                </div>
                                            </div>
                                    </div>
                                </div>
                                <div class="x_panel tile etc-info">
                                    ...
                                    <div class="x_content">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="text" class="form-control " name="RELIGION" value="<%= item._religion %>" readonly />
                                                    <!--
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="text" class="form-control " name="WORK_TYPE" value="<%= workType %>" readonly />
                                                    <!--
                                                    <ul class="list-unstyled">
                                                        <li>
                                                            <input type="checkbox" class="flat" id="WORK_TYPE_INHOUSE" name="WORK_TYPE_INHOUSE" readonly>
                                                            <label for="">입주 선호
                                                            </label>
                                                        </li>
                                                        <li>
                                                            <input type="checkbox" class="flat" id="WORK_TYPE_COMMUTE" name="WORK_TYPE_COMMUTE" readonly>
                                                            <label for="">출퇴근 선호
                                                            </label>
                                                        </li>
                                                    </ul>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <textarea name="MEMO" id="MEMO" rows="4" class="form-control" readonly><%= item._memo %></textarea>
                                                </div>
                                            </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="row sido">
                                            <div class="col-md-2 col-sm-2 col-xs-12">
                                                <h4>
                                                    ...
                                                    시/도: <div id="subBelong_up"></div>
                                                </h4>
                                            </div>
                                            <div class="col-md-10 col-sm-10 col-xs-12">
                                                <h4>
                                                    <i class="fa fa-check"></i>
                                                    시/군/구: <div id="subBelong"></div>
                                                </h4>
                                            </div>
                                        </div>
                                        <!-- 희망근무지역선택 -->
                                        ...
                                        <div class="row sido">
                                            <div class="col-md-2 col-sm-2 col-xs-12">
                                                <h4>
                                                    <i class="fa fa-check"></i>
                                                    시/도: <div id="subWish_up"></div>
                                                </h4>
                                            </div>
                                            <div class="col-md-10 col-sm-10 col-xs-12">
                                                <h4>
                                                    <i class="fa fa-check"></i>
                                                    시/군/구: <div id="subWish"></div>
                                                </h4>
                                            </div>
                                        </div>
                                    </div>
