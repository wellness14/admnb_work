...
<head>
    ...
    <script>
        ...
        function setWorkType(val) {
            /*
            if (val.localeCompare("INHOUSE") == 0) {
                document.getElementById("WORK_TYPE_INHOUSE").checked = true;
            } else if (val.localeCompare("COMMUTE") == 0) {
                document.getElementById("WORK_TYPE_COMMUTE").checked = true;
            } else if (val.localeCompare("BOTH") == 0) {
                document.getElementById("WORK_TYPE_INHOUSE").checked = true;
                document.getElementById("WORK_TYPE_COMMUTE").checked = true;
            } else {
                alert("Error: Unknown value in the field of work type.[" + val + "]");
            }
            */
            //$('.checkbox').checkbox();
            //var liId = $(this).parent("input").attr("id");
            //alert(liId);
        }
                                ...
                                <div class="x_panel tile">
                                    ...
                                    <div class="x_content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="text" required="required" class="form-control" name="NAME" value="<%= item._name %>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="text" required="required" class="form-control" name="SOCIAL_NUM" value="<%= item._socialNum %>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="POST" placeholder="우편번호" value="<%= item._post %>">
                                                        <span class="input-group-btn">
                                                            <button type="button" class="btn btn-primary btn-addr-search">검색</button>
                                                        </span>
                                                    </div>
                                                    <input type="text" class="form-control addr1" name="ADDRESS1" placeholder="주소" value="<%= item._address1 %>">
                                                    <input type="text" class="form-control addr2" name="ADDRESS2" placeholder="상세주소" value="<%= item._address2 %>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="text" class="form-control" name="MOBILE" placeholder="예시) 010-0000-0000" value="<%= item._mobile %>">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="text" class="form-control" name="PHONE" placeholder="예시) 02-0000-0000" value="<%= item._phone %>">
                                                </div>
                                            </div>
                                    </div>
                                </div>
                                ...
                                <div class="x_panel tile">
                                    ...
                                    <div class="x_content">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="text" class="form-control " name="EDUCATION" value="<%= item._education %>" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="text" class="form-control " name="INSURANCE" value="<%= item._insurance %>" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <input type="date" class="form-control " name="HEALTH_CARE" value="<%= df.format(item._health) %>" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    시작
                                                    <input type="date" class="form-control input-inline start-date" name="BENEFIT_BEGIN" value="<%= df.format(item._benefitBegin) %>" />
                                                    <br/> 종료
                                                    <input type="date" class="form-control input-inline end-date" name="BENEFIT_END" value="<%= df.format(item._benefitEnd) %>" />
                                                </div>
                                            </div>
                                    </div>
                                </div>
                                <div class="x_panel tile etc-info">
                                    ...
                                    <div class="x_content">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <ul class="list-unstyled">
                                                        <li>
                                                            ...
                                                            <%= item._workType.equals("INHOUSE") || item._workType.equals("BOTH") ? "checked" : "" %>
                                                            >
                                                            <label for="">입주 선호
                                                            </label>
                                                        </li>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                    <textarea name="MEMO" id="MEMO" rows="4" class="form-control"><%= item._memo %></textarea>
                                                </div>
                                            </div>
                                    </div>
                                </div>
