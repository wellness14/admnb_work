...
<%!
	...
	String toJSON(Rental item)
	{
		...
		json += "\"DESCRIPTION\":\"" + item._description.replace("\n", "\\n") + "\",";
	...
	public String onGet()
	{
		_item = UserDB.getRental(_item._index);
		return toJSON(_item);
	}

	public String onSet()
	{
		UserDB.updateRental(_item);
		return "";
	}

	public String onDelete()
	{
		UserDB.deleteRental(_item);
		return "";
	}
...
<%
	...
	UserDB.PrintLog("API for rental");
	getItem();
