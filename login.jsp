        ...
        <div class="login_wrapper">
            <div class="animate form login_form">
                <section class="login_content">
                    <h2>마더앤베이비 관리자</h2>
					<form action="login_check.jsp" id=login method=post>
                        ...
                        <div class="inputGroup inputGroup1">
                            ...
                            <!--<input type="text" id="email" class="email" maxlength="256" placeholder="아이디"/>-->
							<input type=text name="ID" value="" class="email" maxlength="256" placeholder="아이디"/>
                            <span class="indicator"></span>
                        </div>
                        <div class="inputGroup inputGroup2">
                            <!-- <label for="password">비밀번호</label> -->
                            <!--<input type="password" id="password" class="password" placeholder="비밀번호"/>-->
							<input type=password name="PASSWORD" value="" class="password" placeholder="비밀번호"/>
                        </div>
                        <div class="inputGroup inputGroup3">
                            <!-- <button id="login">입장</button> -->
                            <a id="login" class="login" onclick="document.getElementById('login').submit();">입장</a>
                        </div>
                    ...
                    <p class="first">계정 생성은 관리자에게 문의하세요.</p>
                    <p>로그인하시면 부여된 권한으로 메뉴를 이용할 수 있습니다.</p>
                    <p>관리자의 계정을 외부로 유출하는 경우 법적인 제재를 받을 수 있습니다.</p>
                </section>
            </div>
        </div>
    </div>
		...
		<form action="login_check.jsp" method=post>
			<table border=1>
				...
				<tr>
					<td>Password</td>
					<td>
						<input type=password name="PASSWORD" value="manager_password"/>
					</td>
				</tr>
				<tr>
